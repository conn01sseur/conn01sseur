<div align="center">
  ...
  <h4>💡 Мне просто нравится создавать что-то. Оссобенно что-то новое</h4>
  <h4>💭 Я тут подумал, что, может, перейти полностью на macOS?</h4>
  <h4>🧠 И, да, я знаю, что не надо тут писать свои мысли, но кто мне запрещает это делать?</h4>
  <div align="center">
      ...
      <img src="https://github.com/conn01sseur/conn01sseur/blob/main/obss.png" alt="PNG" style="width:100px; height:100px"/>
  </div>
